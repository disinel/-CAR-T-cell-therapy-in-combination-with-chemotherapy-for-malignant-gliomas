...
r1=median(r1val); r2=r1; alpha1=median(alpha1val);  alpha3=median(alpha3val); rho1=median(rho1val); rho2=median(rho2val); rho3=median(rho3val); 
...
Np=100; Sy=(L1*(L11+1))*Np+Np+(L2-1)*Np+Np+(LL1*(L11+1))*Np+Np; 
 
 
Tc0=10^(10); fs2=0.5; frc=0.01;  S10=(1-fs2-frc)*Tc0; S20=fs2*Tc0; RC0=frc*Tc0; 
