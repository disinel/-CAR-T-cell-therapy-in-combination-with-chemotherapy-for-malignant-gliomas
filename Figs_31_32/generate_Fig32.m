...
% The time interval between the application of two consecutive TMZ applications (Tgap1), 
% the time interval between two consecutive CAR-T applications (Tgap2)
% and the time interval between two consecutive TMZ applications (Tgap3)
Tfinal=500; Tgap1=1; Tgap2=7; Tgap=1;


% Length and number of TMZ cycles
% Length and number of CAR-T cycles
T1=28; L1=10; T11=1; L11=4; T2=14; L2=2; LL1=5;
...
[tt, Y] = calc_1cycle(r1,r2,alpha1,a2,alpha3,rho1,rho2,rho3,rho4,epsilon1,gamma1,gamma2,gamma3,mu,V,K,Np,T1,T11,L1,LL1,L11,T2,L2,S10,S20,RC0,E0,Tfinal,Tgap);
...
function [tt, Y] = calc_1cycle(r1,r2,alpha1,a2,alpha3,rho1,rho2,rho3,rho4,epsilon1,gamma1,gamma2,gamma3,mu,V,K,Np,T1,T11,L1,LL1,L11,T2,L2,S10,S20,RC0,E0,Tfinal,Tgap)
...
[t,y]=calc(ics,L1*T1,L1*T1+Tgap,r1,r2,alpha1,a2,alpha3,rho1,rho2,rho3,rho4,epsilon1,gamma1,gamma2,gamma3,mu,V,Np);
tt(M*Np+1:M*Np+Np)=t;
Y(M*Np+1:M*Np+Np,:)=y;
M=M+1;
...
for i=1:L2-1
    [t,y]=calc(ics,L1*T1+Tgap+T2*(i-1),L1*T1+Tgap+T2*i,r1,r2,alpha1,a2,alpha3,rho1,rho2,rho3,rho4,epsilon1,gamma1,gamma2,gamma3,mu,V,Np);
...
[t,y]=calc(ics,L1*T1+Tgap+(L2-1)*T2,Tfinal,r1,r2,alpha1,a2,alpha3,rho1,rho2,rho3,rho4,epsilon1,gamma1,gamma2,gamma3,mu,V,Np);
tt(M*Np+1:M*Np+Np)=t;
Y(M*Np+1:M*Np+Np,:)=y;
M=M+1;
