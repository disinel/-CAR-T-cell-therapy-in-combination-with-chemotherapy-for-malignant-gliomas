...
% Fixed parameters
g1=10^(10); g2=10^(10); g3=2*10^(9); v=0.5*10^(8); K=5*10^(12); mu=8.32; E0=1;
...
% Main loop that performs computations for each value of the number of TMZ cycles
parfor n=1:N
      ...
      ics=zeros(1,5)'; ics(1)=S10/K; ics(2)=S20/K; ics(3)=RC0/K; ics(4)=0; ics(5)=0;
    
      [t,y,te] = calc_event(ics,0,Tfinal,r1,r2,alpha1,a2,alpha3,rho1,rho2,rho3,rho4,epsilon1,gamma1,gamma2,gamma3,mu,Np,K)
...
save("Notreatment_r2=2r1_max_rho4_"+ceil(100*max(rho4val))+"_N="+N);
...
function [te] = calc_1cycle(r1,r2,alpha1,a2,alpha3,rho1,rho2,rho3,rho4,epsilon1,gamma1,gamma2,gamma3,mu,V,K,Np,T2,L2,S10,S20,RC0,Tfinal)
