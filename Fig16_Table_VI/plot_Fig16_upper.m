...
clearvars -except Tnt Tsc Tst Tstc Tstctc Tsct Tsctc Tstct;
...
clearvars -except Tnt Tsc Tst Tstc Tstctc Tsct Tstct Tsctc Tsctct;
...
ylim([0 2600]);
yticks([0 653 1300 2600]);
ylabel('T_{s}');
hold on;
lines1 = findobj(gcf, 'type', 'line');
set(lines1,'LineWidth',1);
yline(653,'--black','LineWidth',1.5);
