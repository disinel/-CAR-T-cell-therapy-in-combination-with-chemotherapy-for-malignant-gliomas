...
parfor n=1:N 
    ...
    r1=r1val(n); r2=1*r1; alpha1=alpha1val(n);  alpha3=alpha3val(n); rho1=rho1val(n); rho2=rho2val(n); rho3=rho3val(n); rho4=rho4val(n); epsilon1=epsilon1val(n);
...
save("CAR-T_TMZ_Tsurv_max_r1_0_025_rho4_r2=2r1_"+ceil(100*max(rho4val))+"_v_"+v/10^(8)+"_N="+N+".mat");
