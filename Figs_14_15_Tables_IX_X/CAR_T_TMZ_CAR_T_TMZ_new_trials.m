...
Table_IX= sortrows(table(Vars',round(cf',2),round((pv'),3)),2,'descend','ComparisonMethod','abs');



%  Saving generated data
save("CAR-T_TMZ_CAR-T_TMZ_surv_max_r1_0_025_rho4_"+ceil(100*max(rho4val))+"_v_"+v/10^(8)+"_N="+N+".mat");
...
yy0=ics;
options = odeset('RelTol',1e-10,'Events',@events,NonNegative=[1,2,3,4,5]); %, 'AbsTol', 1e-12); %,'AbsTol',1e-13);
