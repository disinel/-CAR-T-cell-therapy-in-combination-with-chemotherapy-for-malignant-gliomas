...
% Computation of the correlation coefficient presented in Table IX.  
...
% Correlation coefficients for Table X
...
Table_X= sortrows(table(Vars',round(cf',2),round((pv'),3)),2,'descend','ComparisonMethod','abs');
