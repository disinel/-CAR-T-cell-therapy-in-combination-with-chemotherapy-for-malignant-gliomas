...
% The number of CAR-T cells applications
L2=2; 
...
% Number of different time gaps considered and their durations in days.  
Q=30; TT2=linspace(1,Q,Q); Tsurv=zeros(Q,N);
...
figure();
plot(TT2,Tsm,'-black','LineWidth',1.5);
xlabel('T_{2}');
ylabel('$\overline{T}_{surv}$','interpreter','latex');

% Saving generated data
save("CAT-T_only_T2_dep_N="+N);
