...
Np=100; Sy=Np+(L1*(L11+1))*Np+Np+Np; 
...
r1=median(r1val); r2=0.5*r1; alpha1=median(alpha1val);  alpha3=median(alpha3val); rho1=median(rho1val); 

rho2=median(rho2val); rho3=median(rho3val); rho4=median(rho4val); epsilon1=median(epsilon1val);


[tt, Y] = calc_1cycle(r1,r2,alpha1,a2,alpha3,rho1,rho2,rho3,rho4,epsilon1,gamma1,gamma2,gamma3,mu,V,K,Np,T1,T11,L1,L11,S10,S20,RC0,E0,Tfinal,Tgap1,Tgap2);
...
xticks([0 250 500]);
yticks([1*10^(10) 3*10^(11) 6*10^(11)]);
xlabel('t');
...
function [tt, Y] = calc_1cycle(r1,r2,alpha1,a2,alpha3,rho1,rho2,rho3,rho4,epsilon1,gamma1,gamma2,gamma3,mu,V,K,Np,T1,T11,L1,L11,S10,S20,RC0,E0,Tfinal,Tgap1,Tgap2)


Sy=Np+(L1*(L11+1))*Np+Np+Np; 
...
[t,y]=calc(ics,Tgap2+L1*T1+Tgap1,Tfinal,r1,r2,alpha1,a2,alpha3,rho1,rho2,rho3,rho4,epsilon1,gamma1,gamma2,gamma3,mu,V,Np);
