...
[te] = calc_1cycle(r1,r2,alpha1,a2,alpha3,rho1,rho2,rho3,rho4,epsilon1,gamma1,gamma2,gamma3,mu,V,K,Np,T1,T11,L1,L11,S10,S20,RC0,E0,Tfinal,Tgap1,Tgap2)
...
save("CAR-T_TMZ_CAR-T_surv_max_r1_0_025_rho4_"+ceil(100*max(rho4val))+"_v_"+v/10^(8)+"_N="+N+".mat");
...
function [te] = calc_1cycle(r1,r2,alpha1,a2,alpha3,rho1,rho2,rho3,rho4,epsilon1,gamma1,gamma2,gamma3,mu,V,K,Np,T1,T11,L1,L11,S10,S20,RC0,E0,Tfinal,Tgap1,Tgap2)
...
[t,y,te]=calc_event(ics,Tgap2+L1*T1+Tgap1,Tfinal,r1,r2,alpha1,a2,alpha3,rho1,rho2,rho3,rho4,epsilon1,gamma1,gamma2,gamma3,mu,Np,K);
if not(isempty(te)) return; end
