...
% Computation of the correlation coefficient presented in Table VII.  
...
% Correlation coefficients for Table VII
...
Table_VIII= sortrows(table(Vars',round(cf',2),round((pv'),3)),2,'descend','ComparisonMethod','abs');
